...
| `CC_LANGFUSE_TAGS` | Optional. Comma-separated tags added to every trace (for example `team:platform,ticket-123`), so traces can be filtered per project, repo or work item. Blank entries are dropped. |
